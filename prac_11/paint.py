...
def getSquareFixed(x1, y1, x2, y2):
...
while True:
    ...
    if poligons:
        ...
        pygame.draw.rect(panel, WHITE, (520, 20, 55, 55), 2)  # square
        pygame.draw.rect(panel, WHITE, (600, 20, 55, 55), 2)  # triangle right
        pygame.draw.rect(panel, WHITE, (680, 20, 55, 55), 2)  # triangle eq
        pygame.draw.rect(panel, WHITE, (760, 20, 55, 55), 2)  # rhombus
                    ...
                    if tool == 3:
                        ...
                        if tool == 1:
                            ...
                            pygame.draw.rect(screen, COLOR,
                                            pygame.Rect(getSquareFixed(x1, y1, x2, y2)), 1)
                        elif tool == 10:
                            pygame.draw.polygon(screen, COLOR,
                                                getRightTriangle(x1, y1, x2, y2), 1)
                        elif tool == 11:
                            pygame.draw.polygon(screen, COLOR,
                                                getEquilateralTriangle(x1, y1, x2, y2), 1)
                        elif tool == 12:
                            pygame.draw.polygon(screen, COLOR,
                                                getRhombus(x1, y1, x2, y2), 1)    
