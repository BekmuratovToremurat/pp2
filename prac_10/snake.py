...
class Snake:
    def __init__(self, pos, walls):
        ...
        self.head_img = pygame.image.load('img/head.png')
        self.body_img = pygame.image.load('img/body.png')
        self.tail_img = pygame.image.load('img/tail.png')
        self.turn_img = pygame.image.load('img/turn.png')  # Новый изгиб тела
